---
title: "Phase 1 — Go Test Architecture"
description: "Hand-written test layout for IBEX Harness Phase 1 (auth + proxy). Generated protobuf code is out of scope for the coverage gate; contract tests live beside `.proto` sources."
summary: "Hand-written test layout for IBEX Harness Phase 1 (auth + proxy). Generated protobuf code is out of scope for the coverage gate; contract tests live beside `.proto` sources."
