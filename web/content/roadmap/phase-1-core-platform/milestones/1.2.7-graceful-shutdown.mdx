...
fullTitle: "Milestone 1.2.7 — Graceful Shutdown and Connection Draining"
---
...
- [1.2.1](/roadmap/phase-1-core-platform/milestones/1.2.1-proxy-auth-client) merged — gRPC client connection pool exists in proxy
- [1.1.3](/roadmap/phase-1-core-platform/milestones/1.1.3-auth-token-validation) merged — auth gRPC server exists
...
Document in `web/engineering/ENVIRONMENT_VARIABLES.md`.
...
| `web/engineering/ENVIRONMENT_VARIABLES.md` | Add IBEX_SHUTDOWN_TIMEOUT_SECONDS |
