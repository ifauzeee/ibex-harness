...
fullTitle: "Milestone 1.4.3 — Health Check Contract and Standardisation"
---
...
- [ ] Kubernetes probe configuration documented in `web/engineering/OPS_GUIDE.md`
