...
fullTitle: "Milestone 1.3.2 — Prometheus Metric Catalog and Client Migration"
---
...
- [1.3.1](/roadmap/phase-1-core-platform/milestones/1.3.1-otel-providers) merged — OTel providers initialized; `packages/telemetry` exists
