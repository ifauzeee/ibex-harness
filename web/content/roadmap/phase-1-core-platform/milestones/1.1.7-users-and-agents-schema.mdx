...
| `web/engineering/DATABASE_SCHEMA.md` | Annotate users/agents as "applied via M1.1.7" |
...
- [ ] ADR-0014 written and indexed in `web/engineering/adr/README.md`
- [ ] `web/engineering/DATABASE_SCHEMA.md` updated to reflect applied status
