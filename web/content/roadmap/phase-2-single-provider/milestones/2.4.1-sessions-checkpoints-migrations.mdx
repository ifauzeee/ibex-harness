...
**ADR required:** ADR-0032 — Session data model and retention strategy
...
- [ ] ADR-0032 written covering session lifecycle, retention policy, and Phase 3 extraction model
