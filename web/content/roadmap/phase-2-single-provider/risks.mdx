---
title: "Phase 2 — Risks and Mitigations"
description: "See phase-1 risks for shared platform risks (RLS, secrets, CI)."
summary: "See phase-1 risks for shared platform risks (RLS, secrets, CI)."
...
| Streaming backpressure under slow clients | 2.1.3 | Medium | High | Context cancellation; dual-write buffer limits per ADR-0027 |
...
See [phase-1 risks](/roadmap/phase-1-core-platform/risks) for shared platform risks (RLS, secrets, CI).