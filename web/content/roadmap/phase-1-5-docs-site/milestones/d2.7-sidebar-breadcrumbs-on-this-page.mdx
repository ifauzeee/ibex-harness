...
| --- | --- | --- |
| `web/src/components/layout/docs-sidebar.tsx` | Modify | Sidebar chrome |
| `web/src/components/layout/breadcrumb.tsx` | Add/Modify | Breadcrumb trail |
| `web/src/components/layout/toc.tsx` | Modify | On-this-page rail |
| `web/src/lib/layout.config.tsx` | Modify | Wordmark nav config |
