---
title: "d2.8 NOT Found"
description: "Broken links and mistyped URLs must return HTTP 404 with branded recovery paths, not a generic Next.js error or soft 200. Landing site visitors following old links need clear paths back to `ibexharness.com` and docs home."
summary: "Broken links and mistyped URLs must return HTTP 404 with branded recovery paths, not a generic Next.js error or soft 200. Landing site visitors following old links need clear paths back to `ibexharness.com` and docs home."
status: "completed"
milestoneId: "d2.8"
goal: "[D.2](/roadmap/phase-1-5-docs-site/goals)"
estimatedEffort: "1 hour"
phase: "phase-1-5-docs-site"
fullTitle: "Milestone D.2.8 — NotFound + home redirect"
---
...
Spec detail: [MASTER_BRIEF.md](/roadmap/phase-1-5-docs-site/master-brief) Part D (D.2.8).
...
- `web/src/app/not-found.tsx` — 72px mono `404`, outline buttons
...
| --- | --- | --- |
| `web/src/app/not-found.tsx` | Add | Styled 404 page |
| `web/next.config.mjs` | Verify | Root redirect intact |
