...
| --- | --- | --- |
| `web/src/app/globals.css` | Add/Modify | Matte Graphite tokens |
| `web/tailwind.config.ts` | Modify | Tailwind color bridge |
| `web/src/app/layout.tsx` | Modify | Fonts and metadata |
