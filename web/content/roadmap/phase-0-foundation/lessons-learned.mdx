...
- Update `web/content/roadmap/current-state.mdx` after every milestone merge.
- Log pivots in `web/content/roadmap/findings.mdx` instead of rewriting archived foundation audits in the session workspace.