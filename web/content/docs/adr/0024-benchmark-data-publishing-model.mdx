...
- Publishing to `main` is handled by [`ibexharness-benchmark-bot`](https://github.com/Rick1330/ibexharness-benchmark-bot) via `repository_dispatch` after main benchmark runs.
- Harness `notify-benchmark-bot` job sends dispatch when `BENCHMARK_BOT_ENABLED=true`.
