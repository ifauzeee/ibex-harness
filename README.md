...
- **Prerequisites**: Docker, Go, Buf, Make. See [`web/engineering/TOOLCHAIN.md`](web/engineering/TOOLCHAIN.md).
- **Full setup and local workflow**: [`web/engineering/DEVELOPMENT_GUIDE.md`](web/engineering/DEVELOPMENT_GUIDE.md).
...
- **Architecture**: [`web/engineering/ARCHITECTURE.md`](web/engineering/ARCHITECTURE.md)
- **Environment variables**: [`web/engineering/ENVIRONMENT_VARIABLES.md`](web/engineering/ENVIRONMENT_VARIABLES.md)
- **Contributing**: [`CONTRIBUTING.md`](CONTRIBUTING.md) — see § Good first issues for beginner-friendly tasks
...
- **OpenSSF Best Practices**: [`web/engineering/OPENSSF_BEST_PRACTICES.md`](web/engineering/OPENSSF_BEST_PRACTICES.md)
