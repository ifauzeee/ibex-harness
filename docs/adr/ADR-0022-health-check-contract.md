...
- K8s probe examples live in [OPS_GUIDE.md](../OPS_GUIDE.md)

## References

- [M1.4.3 milestone](../roadmap/phase-1-core-platform/milestones/1.4.3-health-check-contract.md)
- [ADR-0020](ADR-0020-shared-package-boundaries.md)
