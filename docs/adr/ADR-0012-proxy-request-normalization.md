...
- `services/proxy/internal/upstream/` — reserved for Phase 2 provider HTTP client ([FILE_STRUCTURE.md](../FILE_STRUCTURE.md))
...
Uses existing `services/proxy/internal/errors/` envelope ([ADR-0011](ADR-0011-proxy-auth-client.md)).

### 5) Logging

Per [SECURITY.md](../SECURITY.md) §10.1: after successful parse, log **metadata only** — `org_id`, `request_id`, `model`, `message_count`, `stream`. Never log message `content`.
...
- [Milestone 1.2.2](../roadmap/phase-1-core-platform/milestones/1.2.2-proxy-request-normalization.md)
- [Milestone 1.2.3](../roadmap/phase-1-core-platform/milestones/1.2.3-proxy-input-validation-and-stable-error-envelope.md)
- [API_DOCUMENTATION.md](../API_DOCUMENTATION.md) — LLM Proxy API
