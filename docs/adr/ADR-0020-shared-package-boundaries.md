...
- Full envelope preserved: `field_errors`, `detail`, `docs_url`, `timestamp` ([ADR-0013](ADR-0013-proxy-input-validation-and-error-envelope.md))
...
- [M1.4.2 milestone](../roadmap/phase-1-core-platform/milestones/1.4.2-shared-config-and-error-packages.md)
