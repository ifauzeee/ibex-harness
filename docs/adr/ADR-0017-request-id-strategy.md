...
- [Milestone 1.2.6](../roadmap/phase-1-core-platform/milestones/1.2.6-request-id-correlation-middleware.md)
- [ADR-0013](ADR-0013-proxy-input-validation-and-error-envelope.md) (amended §7)
- [ADR-0016](ADR-0016-agent-identity-verification.md)
