...
- Long-term publishing to `main` moves to a **separate repository** ([`ibex-benchmark-bot`](https://github.com/Rick1330/ibex-benchmark-bot)) running a dedicated GitHub App.
...
- [`ibex-benchmark-bot`](https://github.com/Rick1330/ibex-benchmark-bot) — external app specification and implementation (follow-up)
