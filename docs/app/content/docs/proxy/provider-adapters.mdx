...
<Callout type="experimental" title="Phase 2 milestone">
  The first OpenAI adapter lands in milestone [2.1.1 Provider interface and registry](/roadmap/phase-2-single-provider/milestones/2.1.1-provider-interface-and-registry), blocked until Phase 1.5 docs launch completes.
</Callout>
