...
- [2.3.1](./2.3.1-directive-migrations.md) merged — directive tables exist
- [1.4.2](../../phase-1-core-platform/milestones/1.4.2-shared-config-and-error-packages.md) merged — packages/config available
