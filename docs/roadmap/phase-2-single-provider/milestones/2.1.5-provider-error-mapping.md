...
- [2.1.2](./2.1.2-openai-non-streaming-client.md) merged (non-streaming client exists)
- [2.1.3](./2.1.3-openai-streaming-forwarder.md) merged (streaming path exists)
- [1.2.3](../../phase-1-core-platform/milestones/1.2.3-proxy-input-validation-and-stable-error-envelope.md) merged (error envelope)
