...
- **Phase 1.5 Wave 0 (#96):** roadmap scaffold, ADR-0023, 21 milestone specs, `MASTER_BRIEF.md`, repo-guards allows `apps/` + pnpm root files — next [D.1.1](phase-1-5-docs-site/milestones/d1.1-pnpm-workspace-turborepo.md)
