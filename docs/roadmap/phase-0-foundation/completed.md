...
Foundation milestones were delivered as numbered audits and GitHub PRs. Archived copies live in the session workspace at `ibex-harness-workspace/archive/foundation/` (sibling to the git clone; see [DEVELOPMENT_GUIDE.md](../../DEVELOPMENT_GUIDE.md) §12).
