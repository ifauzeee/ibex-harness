...
**Current milestone:** [1.3.3 Shared structured logger package](milestones/1.3.3-shared-logger-package.md)
...
| 1.3.3 | [Shared structured logger package](milestones/1.3.3-shared-logger-package.md) | Next |
