...
- [1.1.7](./1.1.7-users-and-agents-schema.md) merged — `users` and `agents` tables exist
- [1.2.7](./1.2.7-graceful-shutdown.md) merged — services start and stop cleanly
- [1.2.4](./1.2.4-proxy-rate-limit-skeleton.md) merged — rate limit middleware wired
