...
- [ ] Create `infra/migrations/postgres/` with numbered SQL files:
  ...
  - [ ] `000002_organizations.up.sql` — subset of [DATABASE_SCHEMA.md](../../../DATABASE_SCHEMA.md) organizations table
...
- [ ] Document env vars in [ENVIRONMENT_VARIABLES.md](../../../ENVIRONMENT_VARIABLES.md) (`POSTGRES_DSN` for migrate)
...
Per [TESTING_STRATEGY.md](../../../TESTING_STRATEGY.md): do not mock RLS behavior.
...
- `docs/roadmap/CURRENT_STATE.md` after merge
...
[../../prompts/MILESTONE-1.1.1-postgres-migrations.md](../../prompts/MILESTONE-1.1.1-postgres-migrations.md)
