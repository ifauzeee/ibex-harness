...
Agents should leave handoff notes at the end of a session or PR in the **session workspace** (`handoff.md` next to the clone; see `web/engineering/DEVELOPMENT_GUIDE.md` §12), not in the git repository.
